...
class PDF(FPDF):
    def create_table(self, table_data, title='', data_size = 10, title_size=12, align_data='L', align_header='L', cell_width='even', x_start='x_default',emphasize_data=["Gelir","Gider"], emphasize_style=None,emphasize_color=(0,0,255)): 
        """
        table_data: 
